...
#define  FRAMEBOX       1
#define  CELLBOX        2
#define  FRAMEBOXCPLX   3
#define  CHECKBOX       4
#define  CHECKBOXDROP   5
#define  MULTILINEBOXD  6
#define  MULTILINEBOX   7
#define  MULTIBOX       8
#define  CELLBOXDIVIDED 9
#define  FRAMEBDIVIDED  10
#define  LINES          11
#define  SEPCELLBOX     30
...
// ---------------------------functions ------------------------
    ...
    int segBoxes(WORD wDpiX, WORD wDpiY, int * pH, int n, int * pCw, int * pCut,  int * pWidth, int * pHeight, int * pNCut, long * pCost, int version);
    ...
    int segFixedPitch2(WORD wDpiX, WORD wDpiY, int * pH, int n, int * pCw, int * pCut,  int * pNCut, long *pCost, int version);
    ...
    int  segFont(IMAGEL *pImage, int * pH, int n,  long angle, long shift, RECCHARSTRUCT * pRecCharStruct,
                 int *pCw, int *pCut, int *pNCut, long *pCost, int *pOut, int version, char *fieldName);
